...
(function() {
  ...
  var protocols = admin.nodeInfo.protocols;

  console.log('');
  console.log('------------------------------------------')
  console.log('⛏ Localhost Ethereum Dev Net Stats');
  console.log("⛏ Difficulty: " + protocols.eth.difficulty);
  console.log("⛏ Threads: " + config.threads + " threads");
  console.log('------------------------------------------')
  console.log('');
